...
class Answer(QWidget, Ui_Answer):
    ...
    def __init__(self, resultsDict):
        ...
        self.textEditBlood.setText(
            self.__prepareContentOrgan(resultsDict, "Blood"))
        self.textEditUrine.setText(
            self.__prepareContentOrgan(resultsDict, "Urine"))
        self.textEditLiver.setText(
            self.__prepareContentOrgan(resultsDict, "Liver"))
