...
class AnswerWidgetTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # set GUI for freshly created QWidget
        self.ui.setupUi(self.answerWidget)
    ...
    def test_changedFontFamily(self):
        ...
        self.assertEqual(self.ui.fontComboBox.receivers(
        ...
        for signal in signalspy:
            print(
                "That was argument's value during setCurrentIndex (for font family change) execution: ", signal[0], "\n")
