...
class MainWindowTest(unittest.TestCase):
    ...
    def test_getDataQueryText(self):        
        ...
        result = self.mainwindow.getDataQueryText('White Blood Cells', 'g/L', 'days', 2, 10, 'female')
        self.assertEqual(schema, result)
        
    def test_saveResultsToDict(self):
        result = self.mainwindow.saveResultsToDict({'Complete Blood Count' : [('WBC', 10, 'g/L')]}, 'female', 2, 'days', self.mainwindow.getBloodDict())
